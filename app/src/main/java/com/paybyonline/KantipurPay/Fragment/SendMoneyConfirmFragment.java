...
//                confirmSendMoney();
    ...
    public void confirmSendMoney(){
        ...
        params.put("walletSentAmount", walletSentAmountVal);
        ...
        params.put("walletSenderCharge", walletSenderChargeVal);
        params.put("walletReceiverCharge", walletReceiverChargeVal);
