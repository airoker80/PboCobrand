...
import com.paybyonline.KantipurPay.Adapter.Model.TextViewStyling;
...
public class BuyPageConfirmFragment extends Fragment  implements View.OnClickListener ,DialogInterface.OnClickListener{
   ...
   Bundle bundle=getArguments();
    ...
    params.put("merchantName",merchantName.toString());
    params.put("scstId",scstId.toString());
    params.put("formCountryId", formCountryId.toString());
    ...
    try {
        ...
        while(itt.hasNext()) {
            ...
            Log.i("msgsss", "key : " + me);
            params.add(me, strVal.get(me).toString());
    ...
    public void handleConfirmFieldContentResponse(JSONObject response) throws JSONException {
        ...
        if (response.getString("msgTitle").equals("Success")){
            ...
            sendParams.put("sCategory",sCategory.getString("id").toString());
            sendParams.put("serviceType", serviceType.getString("id").toString());
...
//                params.add(object.get("fieldName").toString(),object.get("fieldValue").toString());
                    ...
                    sendParams.add(key,obj.get("fieldValue").toString());
