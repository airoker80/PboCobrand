...
import com.paybyonline.KantipurPay.Fragment.AboutUsFragment;
import com.paybyonline.KantipurPay.Fragment.ContactUsFragment;
import com.paybyonline.KantipurPay.Fragment.CustomerSimSalesFragment;
import com.paybyonline.KantipurPay.Fragment.DashboardSlidingFragment;
import com.paybyonline.KantipurPay.Fragment.FavouriteServicesFragment;
import com.paybyonline.KantipurPay.Fragment.GridDashboardFragment;
import com.paybyonline.KantipurPay.Fragment.KycDynamicForm;
import com.paybyonline.KantipurPay.Fragment.NewBookFlightFragment;
import com.paybyonline.KantipurPay.Fragment.ProfileFragment;
import com.paybyonline.KantipurPay.Fragment.RechargeBuyFragment;
import com.paybyonline.KantipurPay.Fragment.RechargedDetailsFragment;
import com.paybyonline.KantipurPay.Fragment.SendMoneyDetailsFragment;
import com.paybyonline.KantipurPay.Fragment.SettingFragment;
import com.paybyonline.KantipurPay.Fragment.SimDetailsFragment;
import com.paybyonline.KantipurPay.Fragment.TransactionReportFragment;
import com.paybyonline.KantipurPay.Fragment.UserNotificationFragment;
...
import com.paybyonline.KantipurPay.usersession.UserInstalledApplicationDetails;
...
public class DashBoardActivity extends AppCompatActivity
    ...
    TextView dashboard,shareandEarn;
    TextView wallet;
    TextView buyPage;
    TextView profile,kycVerification;
    TextView simSales;
    TextView contactUs;
    ...
    TextView aboutUs,history;
    TextView simDetails,Offer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kycVerification = (TextView)findViewById(R.id.kycVerification);
        kycVerification.setOnClickListener(this);
...
//        if(fragment!=null){
        ...
        switch (id){
            ...
            case R.id.signOut:
                ...
                break;
            case R.id.Offer:
                resetSelectedPageDrawable(Offer);
                break;
            case R.id.history:
                resetSelectedPageDrawable(history);
                break;
            ...
            case R.id.purchaseReport:
                ...
                setCurrentFragment(saveFragmentBackstack,id,backPageName);
                break;
            case R.id.kycVerification:
                resetSelectedPageDrawable(kycVerification);
