...
import com.paybyonline.KantipurPay.Activity.CreateAccountActivity;
import com.paybyonline.KantipurPay.Activity.DashBoardActivity;
import com.paybyonline.KantipurPay.Activity.InitialLoadingActivity;
import com.paybyonline.KantipurPay.Activity.LoginActivity;
import com.paybyonline.KantipurPay.configuration.PayByOnlineConfig;
import com.paybyonline.KantipurPay.notification.NotificationProvider;
...
//            params.put("accessToken", instance.myUserSessionManager.getKeyAccessToken());
    ...
    public void makePostJsonRequest(String url, final String processingMessage,
                                    HttpEntity entity, final PboServerRequestListener listener){
